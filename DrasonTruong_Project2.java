 ...
 * ITSS 3312.001
 * Project 2
 * Create a program to play 4 Dice Poker using objects and classes
...
public class DrasonTruong_Project2 { // driver class, should have no variables
	...
	public static void main(String[] args) {
		...
		do { // Start of Game
			...
			if (hands.getReroll() == 0) { // if player does not want to re-roll, will go to next hand 
			} else if (hands.getReroll() > 0) { // don't use re-roll method if not necessary
				System.out.print("Enter the index numbers (0-3) separated by a space of the dice you wish to draw:");
...
class Hands { // Class Hands - contains methods to evaluate hands 
	...
	public int[] rerollArray (int[] array, int reroll) {
		...
		// user gets to choose which index to replace
		if (reroll == 1) {
			int indexX;
